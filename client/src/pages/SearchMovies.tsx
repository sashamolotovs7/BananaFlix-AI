...
const SearchMovies = () => {
  ...
  const [movieProviders, setMovieProviders] = useState<{ [key: number]: any }>({});
  ...
  //function to fetch movie provider
  ...
  const toggleProviders = (id: number) => {
    setExpanded(expanded === id ? null : id);
  };
            ...
            <div key={movie.id} className="col">
              <div className="card shadow-sm border-0">
                ...
                <div className="card-body">
                  <h5 className="card-title">{movie.title}</h5> {/* Title */}
                  <div className="description-container">
                    <p className="card-text">
                      {expanded === movie.id
                        ? movie.overview
                        : truncateText(movie.overview, 100)} {/* Increased truncate length */}
                  ...
                  <div className="text-muted"> {/* Release Date */}
                    {movie.releaseDate &&
                  ...
                  {/* Check if the movie has providers and if it's available on flatrate */}
                  <button
                    className="watch-btn"
